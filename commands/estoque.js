...
module.exports = {
    ...
    run: async(client, message, args) => {
      ...
      const row = new Discord.MessageActionRow()
        ...
        .setDescription(`
        <:ticketlogsa:1072609428219629598> | Gerenciando o estoque do produto: ${db.get(`${adb}.nome`)}
<:estoque:1072582246197903451> | Total Estoque: ${db.get(`${adb}.conta`).length}`)
   ...
   if (interaction.customId === "remestoque") {
     interaction.deferUpdate();
     msg.channel.send("<a:carregando2:1072582203583766568> | Envie a linha do produto que você quer remover!").then(msg => {
      const filter = m => m.author.id === interaction.user.id;
